...
This demo provide an [all-in-one build template](https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift-tensorflow/dev/openshift-build-all-ephemeral.yml)
...
```bash
oc project demo
oc process -f https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift-tensorflow/dev/openshift-build-all-ephemeral.yml \
           -p APP_NAME=digit \
           -p SOURCE_BRANCH=dev \
